...
export const SECTION_SCHEMAS: SectionSchema[] = [
  ...
  // ------------------------------------------------------------- Home page
  {
    ...
    fields: [
      { kind: "text", key: "badge", label: "Top Eyebrow Badge" },
      { kind: "text", key: "title", label: "Headline main line", required: true, help: "Set in solid white." },
      { kind: "text", key: "titleAccent", label: "Headline second line / accent", required: true, help: "Set in sage / outlined type beneath the first line." },
      { kind: "textarea", key: "intro", label: "Introduction", rows: 3, required: true },
      { kind: "text", key: "actionText", label: "Primary Button Text" },
      { kind: "text", key: "actionUrl", label: "Primary Button URL" },
      { kind: "text", key: "secondaryActionText", label: "Secondary Button Text" },
      { kind: "text", key: "secondaryActionUrl", label: "Secondary Button URL" },
      { kind: "image", key: "banner.main.src", label: "Background image", slot: "heroBanner", required: true },
      {
        kind: "list", key: "slides", label: "Banner Slides", itemLabel: "slide", titleKey: "title",
        help: "Add multiple banner slides to turn the home page hero into an interactive carousel.",
        fields: [
          { kind: "text", key: "badge", label: "Eyebrow Badge" },
          { kind: "text", key: "title", label: "Headline Main Line", required: true },
          { kind: "text", key: "titleAccent", label: "Headline Accent Line" },
          { kind: "textarea", key: "intro", label: "Introduction / Description", rows: 3, required: true },
          { kind: "text", key: "actionText", label: "Primary Button Text" },
          { kind: "text", key: "actionUrl", label: "Primary Button URL" },
          { kind: "text", key: "secondaryActionText", label: "Secondary Button Text" },
          { kind: "text", key: "secondaryActionUrl", label: "Secondary Button URL" },
