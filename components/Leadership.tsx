...
import {
  ...
  MANAGEMENT as MANAGEMENT_DEFAULT,
} from "@/data/site";
...
function PersonCard({
  ...
  return (
    ...
    >
      ...
      <p className="mt-0.5 text-[12px] font-medium text-green sm:text-[13px]">
        {person.role}
      </p>
      <p className="mt-1.5 line-clamp-2 text-[12.5px] leading-relaxed text-ink-soft sm:text-[13.5px]">
        {person.bio}
      </p>
